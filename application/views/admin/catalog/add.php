...
<div class="wrapper">
    ...
    <!-- Form -->
    <form class="form" id="form" action="<?php echo admin_url('catalog/add')?>" method="post" enctype="multipart/form-data">
            <fieldset>
                <div class="widget">
                    <div class="title">
                    ...
                    <div class="tab_container">
                        <div id='tab1' class="tab_content pd0">
                            ...
                            <div class="formRow">
                                ...
                                <div class="formRight">
                                    <span class="oneTwo">
                                        <input name="name" id="name" _autocheck="true" type="text" value="<?php echo set_value('name')?>" />
                                    </span>
